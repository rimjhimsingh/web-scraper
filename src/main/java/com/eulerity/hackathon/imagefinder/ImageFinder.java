...
public class ImageFinder extends HttpServlet {
	...
	HashSet<String> imageSet = new HashSet<>(); // To avoid duplicate images
	...
	private static void crawl(String url, int depth, HashSet<String> visited, ArrayList<String> testImages,
